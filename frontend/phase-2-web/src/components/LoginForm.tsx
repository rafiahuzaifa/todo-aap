      ...
      <div className="w-full max-w-md animate-slide-up">
        <div className="luxury-card p-10 rounded-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-4xl font-bold gold-text mb-2">Welcome Back</h2>
            <p className="text-[#999] text-sm">Sign in to your Evolution account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="form-container">
            ...
            <button
              type="submit"
              disabled={loading}
              className="luxury-btn w-full py-3 rounded-lg mt-2 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wider font-semibold"
            >
              {loading ? (
          ...
          <p className="text-center text-[#999] text-sm">
            New to Evolution?{' '}
            <Link href="/register" className="text-[#D4AF37] hover:text-[#F4E4C1] font-bold transition-colors">
              Create Account
            </Link>
          </p>
        </div>
